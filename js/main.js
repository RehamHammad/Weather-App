...
nextDay=document.getElementsByClassName('next-day'),
...
let monthes=['Jan','Feb','Mar','Apr','May','June','July','Aug','Sept','Oct','Nov','Dic']
...
function displayWeatherData(){
    ...
    todayDate.innerHTML=`${date.getDate()} ${monthes[date.getMonth()]}`
...
function displayNextWeatherData(){
